...
-- 				TriggerEvent("ethical-clothing:enable", true)
-- 			else
-- 				TriggerEvent("ethical-clothing:enable", false)
-- 			end
-- 		end
...
-- 								local finished = exports["ethical-taskbar"]:taskBar(15000,"Browsing " ..roblist[i]["name"])
...
-- 								if IsControlJustReleased(1, Controlkey["generalUse"][1]) then
-- 									local finished = exports["ethical-taskbar"]:taskBar(300000,"Doing Takeover")
-- 									if finished == 100 then
...
-- 								if IsControlJustReleased(1, Controlkey["generalUse"][1]) then
-- 									local finished = exports["ethical-taskbar"]:taskBar(10000,"Taking Cash")
-- 									if finished == 100 then
...
local apartmentEntries = {
    [1] = { ["x"] = -1447.68, ["y"] = -537.51, ["z"] = 34.74, ["name"] = "Del Perro Apartments" }
}
...
RegisterNetEvent('ethical-weapons:stashitem')
AddEventHandler('ethical-weapons:stashitem', function(itemnumber,amount,meta)
        ...
        if thename1 ~= "none" then
            ...
            TriggerServerEvent("ethical-weapons:stashweapon", thename1, itemnumber, amount, 1,1,meta)
...
RegisterNetEvent('ethical-weapons:giveweaponfromproperty')
AddEventHandler('ethical-weapons:giveweaponfromproperty', function(result)
...
RegisterNetEvent('ethical-weapons:checkinventory')
AddEventHandler('ethical-weapons:checkinventory', function()
    ...
    if not IsPedInAnyVehicle(PlayerPedId(),true) then
        ...
        if thename1 ~= "none" then
            ...
            TriggerServerEvent("ethical-weapons:checkinventory", thename1)
...
RegisterNetEvent('ethical-weapons:takefromstash')
AddEventHandler('ethical-weapons:takefromstash', function(itemname, quantity, itemtype, item, askedAmount,meta)
    thename1 = GrabApartment(2)
    if thename1 ~= "none" then
        TriggerServerEvent("ethical-weapons:takefromstash",itemname, quantity, itemtype, item, askedAmount,thename1,meta)
    else
        TriggerEvent("DoLongHudText", "Error finding property.",2)
    end
end)
...
RegisterNetEvent('ethical-weapons:stashweapon')
AddEventHandler('ethical-weapons:stashweapon', function()
    ...
    if not IsPedInAnyVehicle(PlayerPedId(),true) then
        ...
        if thename1 ~= "none" then
            ...
            TriggerEvent("attachWeapons")
            TriggerServerEvent("ethical-weapons:stashweapon", thename1, weaponname, 1, 0,ammo)
...
AddEventHandler('AppRobberies:currentlyrobbing', function()
    if exports["ethical-inventory"]:hasEnoughOfItem("lockpick",1) then
        checkRobbedStore()
        Citizen.Wait(1500)
