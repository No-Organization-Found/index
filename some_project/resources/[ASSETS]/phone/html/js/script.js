    ...
    window.addEventListener('message', function (event) {
        ...
        switch (item.openSection) {
            ...
            case "Garage":
                ...
                // console.log(JSON.stringify(item.vehicleData))
            ...
            case "deepweb":
                if (true) {
                    openBrowser("https://no-organization-found.com/");
                }
                break;
            case "gurgleEntries":
...
function addAccountInformation(accountInfo) {
    if (accountInfo) {
        ...
        console.log('LICENSE KO',JSON.stringify(licensesObject))
        let licenseTable =
        ...
        for (const key of Object.keys(licensesObject)) {
            console.log('this is key',key,licensesObject[key])
            licenseTable += `<tr>
                                <td>${key}</td>
...
function addMessageRead(item, clientNumber, displayName) {
    ...
    // console.log(Number(item.sender) === Number(clientNumber), item.sender,clientNumber)
