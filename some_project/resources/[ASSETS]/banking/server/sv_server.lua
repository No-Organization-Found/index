...
AddEventHandler('bank:givemecash', function(sender, reciever, amount)
  local user = exports["ethical-base"]:getModule("Player"):GetUser(sender)
  local player = exports["ethical-base"]:getModule("Player"):GetUser(tonumber(reciever))
...
AddEventHandler('bank:transfer', function(receiver, amount, cid, statement)
  ...
  local player = exports["ethical-base"]:getModule("Player"):GetUser(tonumber(receiver))
...
AddEventHandler("bank:getLogs", function()
  local srcID = source
  local user = exports["ethical-base"]:getModule("Player"):GetUser(srcID)
  local char = user:getCurrentCharacter()
