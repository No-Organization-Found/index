local blips = {
    ...
    {id = "casino1", name = "Casino", color = 0.4, sprite = 207, x = 925.329, y = 46.152, z = 80.908 },
...
--    {id = "Smelting", name = "Smelting", color = 17, sprite = 52, x = 1098.10168457031, y=-1999.86364746094, z=30.3807010650635},
    ...
    {id = "ttruckgarage", name = "Bad Boy Customs", scale = 0.7, color = 30, sprite = 147, x = 946.25, y = -987.78, z = 39.19},
    ...
    {id = "fire1", name = "Fire Station",scale = 0.7, color = 1, sprite = 153, x = 205.30201721191, y = -1651.4327392578, z = 29.803213119507},
    {id = "fire2", name = "Fire Tower",scale = 0.7, color = 1, sprite = 153, x =  -1195.5244140625, y = -1788.2210693359, z = 19.490871429443},

    {id = "fire3", name = "Fire Main",scale = 0.7, color = 1, sprite = 153, x =  1206.3913574219, y = -1473.1184082031, z = 34.859497070313},
    ...
    {id = "di", name = "Driving Instructor", scale = 0.7, color = 44, sprite = 380, x = 983.83, y= -206.17, z= 71.07},
}
